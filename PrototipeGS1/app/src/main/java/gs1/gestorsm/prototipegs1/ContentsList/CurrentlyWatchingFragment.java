...
public class CurrentlyWatchingFragment extends Fragment implements ConnectResponse {
    ...
    public void processFinish(String str, ArrayList<ArrayList<String>> datos) {
        ...
        ArrayAdapter<String> adapter=new ArrayAdapter<>(getActivity(),R.layout.fragment_watching_currently,R.id.textView2
                ,currentlyWatchingElements);
        ListView listView = view.findViewById(R.id.currently_watching_list);
    ...
    private void AddObjets(){
        for (int i = 0; i < datos.size(); i++) {
            currentlyWatchingElements.add(datos.get(i).get(0));
        }
